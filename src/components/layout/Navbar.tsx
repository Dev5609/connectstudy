    ...
    <nav className="border-b border-white/10 bg-black sticky top-0 z-50">
      <div className="container mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-4 md:gap-8">
          <Link href="/" className="font-bold text-lg md:text-xl tracking-tighter flex items-center gap-2">
            <BookOpen className="w-5 h-5 md:w-6 md:h-6" />
            <span className="hidden xs:inline">ConnectStudy</span>
          </Link>
        ...
        <div className="flex items-center gap-2 md:gap-4">
          {user ? (
            <>
              <Dialog open={isJoinDialogOpen} onOpenChange={setIsJoinDialogOpen}>
                <DialogTrigger asChild>
                  <Button variant="outline" size="sm" className="flex gap-2 border-2 border-white/10 hover:border-white/30 uppercase text-[9px] md:text-[10px] font-bold tracking-widest bg-black text-white rounded-none h-8 md:h-10">
                    <LogIn className="w-3.5 h-3.5" />
                    <span className="hidden xs:inline">Join</span>
                  </Button>
                </DialogTrigger>
                <DialogContent className="bg-black border-2 border-white/20 rounded-none w-[90vw] max-w-md">
                  <DialogHeader>
              ...
              <Dialog open={isRoomDialogOpen} onOpenChange={setIsRoomDialogOpen}>
                ...
                <DialogContent className="bg-black border-2 border-white/20 rounded-none w-[90vw] max-w-md">
                  ...
                  <div className="grid gap-4 py-4">
                    ...
                    <div className="grid gap-2">
                      <Label className="text-[10px] font-bold uppercase tracking-widest opacity-60 text-white">Privacy</Label>
                      <Select value={roomType} onValueChange={setRoomType}>
                        <SelectTrigger className="border-2 border-white/10 bg-black rounded-none text-white">
              ...
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <Button variant="ghost" size="sm" onClick={handleLogout} className="text-[9px] md:text-[10px] uppercase font-bold tracking-widest opacity-60 hover:opacity-100 text-white p-0">
            ...
            <Dialog open={isAuthDialogOpen} onOpenChange={setIsAuthDialogOpen}>
              <DialogTrigger asChild>
                <Button variant="outline" size="sm" className="border-2 border-white/10 hover:border-white/30 uppercase text-[10px] font-bold tracking-widest text-white bg-black rounded-none h-10">
                  Sign In
                </Button>
              </DialogTrigger>
              <DialogContent className="w-[90vw] max-w-[400px] bg-black border-2 border-white/20 rounded-none">
                <DialogHeader>
